...
<body style="background-image: url('../view/images/bg-02.jfif'); background-repeat: no-repeat; background-size: cover;"
  class="size-1140">
  <header>
    <div id="topbar">
      <div class="line">
    ...
    <nav>
      <div class="line" style="padding-bottom: 1%;">
        <div class="s-12 l-2">
          <p class="logo" style="margin-left: 13.1%;"><strong>One</strong>page <a href="../controller/proses.php?aksi=refresh" style="margin-left: 67%;">Refresh</a></p>
        </div>
      </div>
    </nav>
  </header>
          ...
          <div class="row justify-content-center">
            <div class="col-md-12">
              <div class="form-block">
                ...
                <form action="../controller/proses.php?aksi=tambahuser" method="post">
                  ...
                  <span class="d-block text-center my-4 text-muted"> Have already an account? <a href="index.php">Login Here</a></span>
